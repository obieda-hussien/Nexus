  ...
  const getPlaceholderCourses = () => [
    {
      ...
      description: 'Learn programming from scratch using Python language with practical examples and applied projects',
      shortDescription: 'Comprehensive course to learn Python programming for beginners',
      price: 299,
      originalPrice: 399,
      isfree: false,
    ...
    {
      id: '2',
      title: 'Secondary stage physics',
      description: 'Detailed and simplified explanation of physics curriculum for third year secondary with problem solving',
      shortDescription: 'Complete physics curriculum for secondary stage',
      price: 0,
      isfree: true,
      thumbnail: '/placeholder-course.jpg',
    ...
    },
    {
      ...
      description: 'Learn to design modern and responsive websites using HTML and CSS',
      shortDescription: 'Website design basics for beginners',
      price: 199,
      originalPrice: 299,
      isfree: false,
      thumbnail: '/placeholder-course.jpg',
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg">
              Choose from a wide range of courses in various fields
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">No courses found matching the selected criteria</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {courses.map(course => (
