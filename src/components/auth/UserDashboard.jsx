...
import { motion } from 'framer-motion'; // Assuming framer-motion is used based on <motion.div>
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const mockCourseProgress = [
        ...
        {
          id: 'chemistry-101',
          title: 'General Chemistry', // Translated from 'Chemistry الyearة'
          progress: 30,
          totalLessons: 18,
          completedLessons: 5,
      ...
      const mockActivity = [
        {
          ...
          title: 'Completed Lesson: Newton\'s Laws', // Translated from 'أكمل درس: قوانين Newton'
          time: '2024-12-29T10:30:00',
          course: 'Physics Basics'
        },
        {
          type: 'quiz_passed',
          title: 'Passed Quiz: Circular Motion', // Translated from 'Passed in Quiz: Motion الدائرية'
          time: '2024-12-29T09:15:00',
          course: 'Physics Basics'
        },
        {
          type: 'course_enrolled',
          title: 'Enrolled in: Advanced Mathematics', // Translated from 'انضم to: Advanced Mathematics'
        ...
        <div className="bg-gradient-to-r from-neon-blue/20 to-neon-purple/20 p-8 text-white border-b border-glass-border relative overflow-hidden">
          ...
          <div className="flex justify-between items-center relative z-10">
            <div className="flex items-center space-x-6">
              ...
              <div>
                <h2 className="text-3xl font-bold text-white mb-1">Welcome, {userProfile?.displayName || 'User'}</h2>
                <p className="text-gray-300 flex items-center">
                  <GraduationCap className="h-4 w-4 mr-1" /> {/* Changed ml-1 to mr-1 for LTR */}
                  Personal Dashboard
                </p>
                <p className="text-sm text-neon-blue/80 mt-1">Ready to learn today?</p>
              </div>
            </div>
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center h-64 space-y-4">
              ...
              {!userProfile && currentUser && (
                <div className="text-center">
                  <p className="text-yellow-400 text-sm">No profile data available</p>
                  <p className="text-gray-400 text-xs">Creating Profile...</p>
                </div>
              )}
            </div>
          ) : !userProfile ? (
            <div className="flex flex-col items-center justify-center h-64 space-y-6">
              <div className="text-red-400 text-xl font-semibold">Error Loading Data</div>
              <div className="text-center max-w-md">
                <p className="text-gray-400 mb-4">
                  Profile data not found.<br/>
                  You might need to create a profile or check your connection.
                </p>
                <div className="bg-blue-900/20 border border-blue-400/30 p-4 rounded-xl">
                  <p className="text-blue-400 text-sm">
                    💡 <strong>Tip:</strong> Use the button below to create a new profile.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-3 grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                ...
                >
                  ...
                  <div className="flex items-center justify-between relative z-10">
                    <div>
                      <p className="text-blue-300 text-sm font-medium mb-1">Enrolled Courses</p>
                      <p className="text-3xl font-bold text-white">{stats.enrolledCourses}</p>
                      <p className="text-xs text-blue-200/60 mt-1">Active Courses</p>
                    </div>
                ...
                >
                  ...
                  <div className="flex items-center justify-between relative z-10">
                    <div>
                      <p className="text-green-300 text-sm font-medium mb-1">Completed Courses</p>
                      <p className="text-3xl font-bold text-white">{stats.completedCourses}</p>
                      <p className="text-xs text-green-200/60 mt-1">Achieved</p>
                    </div>
                ...
                >
                  ...
                  <div className="flex items-center justify-between relative z-10">
                    <div>
                      <p className="text-purple-300 text-sm font-medium mb-1">Study Hours</p>
                      <p className="text-3xl font-bold text-white">{stats.totalStudyTime}</p>
                      <p className="text-xs text-purple-200/60 mt-1">Total Minutes</p>
                    </div>
                ...
                >
                  ...
                  <div className="flex items-center justify-between relative z-10">
                    <div>
                      <p className="text-orange-300 text-sm font-medium mb-1">Streak Days</p>
                      <p className="text-3xl font-bold text-white">{stats.streakDays}</p>
                      <p className="text-xs text-orange-200/60 mt-1">🔥 Active Streak</p>
                    </div>
              ...
              <div className="lg:col-span-2">
                ...
                >
                  <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                    <div className="bg-neon-blue/20 p-2 rounded-lg mr-3"> {/* Changed ml-3 to mr-3 */}
                        ...
                        <div className="relative z-10">
                            ...
                            <div>
                              ...
                              <div className="flex items-center space-x-4 text-sm text-gray-400">
                                <span className="flex items-center">
                                  <CheckCircle className="h-4 w-4 mr-1 text-neon-green" /> {/* Changed ml-1 to mr-1 */}
                                  {course.completedLessons} of {course.totalLessons} Lessons
                                </span>
                                <span className="flex items-center">
                                  <Calendar className="h-4 w-4 mr-1 text-neon-blue" /> {/* Changed ml-1 to mr-1 */}
                          ...
                          <div className="flex justify-end">
                            <button className="bg-gradient-to-r from-neon-blue/20 to-neon-purple/20 hover:from-neon-blue/30 hover:to-neon-purple/30 border border-neon-blue/30 text-neon-blue hover:text-white px-6 py-2 rounded-xl font-medium flex items-center transition-all duration-200 group">
                              <PlayCircle className="h-5 w-5 mr-2 group-hover:scale-110 transition-transform duration-200" /> {/* Changed ml-2 to mr-2 */}
                              Continue Learning
                            </button>
                          </div>
                        </div>
              ...
              <div>
                ...
                >
                  <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                    <div className="bg-neon-purple/20 p-2 rounded-lg mr-3"> {/* Changed ml-3 to mr-3 */}
