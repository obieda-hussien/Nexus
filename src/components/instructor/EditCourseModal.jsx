      ...
      <div className="border-b border-gray-600 bg-gray-800">
        <div className="flex space-x-0">
          {[
            ...
            { id: 'curriculum', label: 'Curriculum & Sections' },
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="border-t border-gray-600 p-6 flex justify-between bg-gray-800">
          ...
          <button
            ...
            disabled={isLoading}
            type="button"
            className="bg-gradient-to-r from-green-500 to-blue-600 text-white px-8 py-3 rounded-xl font-semibold hover:scale-105 transition-transform disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center space-x-2"
          >
...
const SettingsTab = ({ data, onChange }) => {
  return (
    <div className="space-y-6">
      <h3 className="text-xl font-semibold text-white mb-4">Course Settings</h3>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-3">
            ...
            <label htmlFor="isActive" className="text-white font-medium">
              Course is Active and Enrollable
            </label>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <label htmlFor="allowPreview" className="text-white font-medium">
              Allow preview of some lessons for free
            </label>
          </div>
        </div>
      </div>
    ...
    <div className="bg-gray-800 border border-gray-600 rounded-xl p-4">
      ...
      {section.isExpanded && (
        <div className="space-y-3">
          ...
          <button
            onClick={onAddLesson}
            className="w-full bg-gray-700 border border-gray-600 rounded-lg p-3 text-gray-300 hover:text-white hover:bg-gray-600 transition-colors flex items-center justify-center space-x-2"
          >
            <Plus className="w-4 h-4" />
            ...
            <div>
              ...
              <ErrorBoundary>
                <MarkdownEditor
                  ...
                  placeholder="Write the article content using Markdown..."
                />
              </ErrorBoundary>
            </div>
          ) : formData.type === 'video' ? (
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 text-gray-400 text-sm">
                ...
                {lesson.type === 'video' && lesson.duration > 0 && <span>• {lesson.duration} min</span>}
...
const AnalyticsTab = ({ course, sections }) => {
  ...
  if (quizLessons.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-xl font-semibold text-white mb-2">No quizzes in this course</h3>
        <p className="text-gray-400">Add quizzes in the "Curriculum & Sections" tab to view analytics</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-xl font-semibold text-white mb-4">Quiz Analytics</h3>
      
      {/* Overview Stats */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-gray-700 rounded-lg p-4 text-center border border-gray-600">
          <p className="text-2xl font-bold text-white">{quizLessons.length}</p>
          <p className="text-gray-300">Total Quizzes</p>
        </div>
        <div className="bg-gray-700 rounded-lg p-4 text-center border border-gray-600">
          <p className="text-2xl font-bold text-white">
        ...
        <div className="bg-gray-700 rounded-lg p-4 text-center border border-gray-600">
          ...
          <p className="text-gray-300">Published Quizzes</p>
        </div>
      </div>
          ...
          <div key={lesson.id} className="bg-gray-800 border border-gray-600 rounded-lg p-4">
            ...
            {lesson.isPublished ? (
              ...
              <div className="text-center py-8 text-gray-400">
                <p>The quiz must be published to view analytics</p>
              </div>
            )}
          </div>
        ))}
