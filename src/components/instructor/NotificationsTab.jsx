  ...
  const defaultNotifications = [
    {
      id: 1,
      type: 'review',
      title: 'New Rating on Your Course',
      message: 'Your course "Basic Physics" received a 5-star rating from student Ahmed Mohamed',
      time: '10 minutes ago',
      isRead: false,
      icon: Star
    },
    {
      ...
      message: '15 new students joined the "Special Relativity" course',
      time: '30 minutes ago',
      isRead: false,
      icon: Users
    },
    {
      ...
      type: 'system',
      title: 'System Update',
      message: 'New features have been added to Course Management',
      time: '2 hours ago',
      isRead: true,
      icon: Info
    },
    {
      ...
      message: 'The "Quantum Mechanics" course is awaiting content review',
      time: '3 hours ago',
      isRead: false,
      icon: AlertCircle
    }
      ...
      <div className="space-y-3">
        {filteredNotifications.length > 0 ? (
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-12 text-center">
            ...
            <p className="text-white text-xl mb-2">No Notifications</p>
            <p className="text-purple-200">
              {filter === 'unread' ? 'All notifications are read' : 'No notifications in this category'}
            </p>
          </div>
        )}
      </div>
