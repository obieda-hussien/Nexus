...
const SettingsTab = ({ instructorData, onUpdateProfile }) => {
  ...
  const handleWithdrawalRequest = async (amount) => {
    if (amount < formData.minimumWithdrawal) {
      toast.error(`The minimum withdrawal amount is ${formData.minimumWithdrawal} EGP`);
      return;
    }

    if (amount > availableBalance) {
      toast.error('The requested amount is larger than the available balance');
      return;
    }

    if (paymentMethods.length === 0) {
      toast.error('You must add a payment method first');
      return;
    }
    ...
    try {
      ...
      const withdrawal = {
        ...
        expectedProcessing: 'Processing takes 3-5 business days'
      };
    ...
    <div className="space-y-6">
            ...
            {isEditing ? (
              <>
                <button
                  ...
                  className="px-4 py-2 text-purple-200 hover:text-white transition-colors flex items-center space-x-2"
                >
                  <X className="w-4 h-4" />
                  <span>Cancel</span>
                </button>
              ...
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-xl font-semibold flex items-center space-x-2 transition-colors"
              >
          ...
          <div>
            ...
            {isEditing ? (
              <input
                ...
                className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-purple-300 focus:outline-none focus:border-purple-400"
                placeholder="e.g., Professor of Nuclear Physics"
              />
            ) : (
        ...
        <div className="mt-6">
          ...
          {isEditing ? (
            <textarea
              ...
              rows="4"
              className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-purple-300 focus:outline-none focus:border-purple-400"
              placeholder="Write a short bio about your experience and specialization..."
            />
          ) : (
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-6">
        ...
        <div className="space-y-4">
          ...
          <NotificationToggle
            ...
            description="Instant notifications in the application"
          ...
          <NotificationToggle
            ...
            description="Notifications about new messages from students"
          ...
          <NotificationToggle
            ...
            description="Notifications about course updates and comments"
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-6">
        ...
        <div className="space-y-4">
          ...
          <NotificationToggle
            label="Show Email"
            description="Show your email in your profile"
          ...
          <NotificationToggle
            ...
            description="Show your phone number in your profile"
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-gradient-to-r from-blue-500/20 to-blue-600/20 border border-blue-400/30 rounded-xl p-4">
            <h4 className="text-blue-300 text-sm font-medium">Minimum Withdrawal</h4>
          ...
          <div className="bg-gradient-to-r from-purple-500/20 to-purple-600/20 border border-purple-400/30 rounded-xl p-4">
            <h4 className="text-purple-300 text-sm font-medium">Pending Requests</h4>
        ...
        {availableBalance >= formData.minimumWithdrawal && paymentMethods.length > 0 && (
          <div className="bg-white/5 rounded-lg p-4 mb-6">
            <h4 className="text-white font-medium mb-3">Quick Withdraw</h4>
        ...
        <div className="mb-6">
          ...
          {paymentMethods.length === 0 ? (
            <div className="bg-white/5 rounded-lg p-6 text-center">
              ...
              <p className="text-purple-200">No payment methods added yet</p>
              <p className="text-purple-300 text-sm">Add a payment method to be able to withdraw earnings</p>
            </div>
          ) : (
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-purple-200 text-sm mt-1">
                Real payment gateways • Automatic tax reports • Email notifications
              </p>
              <div className="flex items-center space-x-4 mt-3 text-xs">
                <span className="bg-green-500/20 text-green-300 px-2 py-1 rounded-full">✓ Stripe & PayPal</span>
                <span className="bg-blue-500/20 text-blue-300 px-2 py-1 rounded-full">✓ Instapay & Vodafone Cash</span>
                <span className="bg-purple-500/20 text-purple-300 px-2 py-1 rounded-full">✓ PDF & Excel Reports</span>
              </div>
            </div>
            <button
              onClick={() => setShowAdvancedPayment(true)}
              className="bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white px-6 py-3 rounded-lg font-medium flex items-center space-x-2 shadow-lg hover:shadow-xl transition-all duration-300"
            >
              <Zap className="w-5 h-5" />
              <span>Open Advanced System</span>
            </button>
          </div>
        </div>
        ...
        {/* Withdrawal Settings */}
        <div className="space-y-4">
          <h4 className="text-white font-medium">Withdrawal Settings</h4>
          
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <label className="block text-purple-200 text-sm font-semibold mb-2">
                Minimum Withdrawal (EGP)
              </label>
              {isEditing ? (
                <input
                  type="number"
          ...
          <NotificationToggle
            ...
            description="Automatically withdraw earnings on a selected day each month"
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-6">
        ...
        {withdrawalHistory.length === 0 ? (
          <div className="bg-white/5 rounded-lg p-6 text-center">
            ...
            <p className="text-purple-200">No withdrawal history yet</p>
            <p className="text-purple-300 text-sm">All previous and current withdrawal requests will appear here</p>
          </div>
        ) : (
      ...
      {showAddPaymentMethod && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-gray-800 rounded-2xl border border-white/20 p-6 w-full max-w-md">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-purple-200 text-sm font-semibold mb-2">Payment Type</label>
                <select
              ...
              {newPaymentMethod.type === 'bank' && (
                <>
                  <div>
                    <label className="block text-purple-200 text-sm font-semibold mb-2">Bank Name</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-purple-200 text-sm font-semibold mb-2">Account Number</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-purple-200 text-sm font-semibold mb-2">Account Holder Name</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-purple-200 text-sm font-semibold mb-2">IBAN (Optional)</label>
                    <input
                      type="text"
              ...
              {newPaymentMethod.type === 'paypal' && (
                <div>
                  <label className="block text-purple-200 text-sm font-semibold mb-2">PayPal Email</label>
                  <input
                    type="email"
              ...
              {newPaymentMethod.type === 'vodafone' && (
                <div>
                  <label className="block text-purple-200 text-sm font-semibold mb-2">Vodafone Cash Number</label>
                  <input
                    type="tel"
      ...
      case 'bank':
        return (
          <div>
            ...
            <p className="text-purple-200 text-sm">Account: ****{method.accountNumber?.slice(-4)}</p>
  ...
  return (
    <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg border border-white/10">
      <div className="flex items-center space-x-3">
        ...
        {getMethodDetails()}
        {method.isDefault && (
          <span className="bg-green-600/20 text-green-400 px-2 py-1 rounded text-xs">Default</span>
        )}
      </div>
      <button
