...
const QuizEditor = ({ quizData, onChange, placeholder = "Create an interactive quiz..." }) => {
            ...
            <div className="space-y-4">
              ...
              {quiz.questions.length === 0 ? (
                <div className="text-center py-8 text-gray-400">
                  ...
                  <p className="text-sm">Start by adding the first question to the quiz</p>
                </div>
              ) : (
...
const QuestionEditor = ({ question, index, onUpdate, onDelete, onMove, canMoveUp, canMoveDown }) => {
  ...
  const removeOption = (optionId) => {
    if (question.options.length <= 2) {
      toast.error('There must be at least two options');
      return;
    }
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-gray-400 text-sm">
            ({question.type === 'multiple_choice' ? 'Multiple Choice' : 
              question.type === 'true_false' ? 'True or False' : 'Short Answer'})
          </span>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor={`required-${question.id}`} className="ml-2 text-gray-300 text-sm">
                Required Question
              </label>
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Write an explanation for the correct answer..."
              rows="2"
              className="w-full bg-gray-700 border border-gray-500 rounded-lg px-3 py-2 text-white placeholder-gray-400 focus:outline-none focus:border-blue-400"
            />
          </div>
...
const QuizSettings = ({ quiz, onUpdateSetting, onUpdateQuizSetting }) => {
  return (
    <div className="space-y-6">
      ...
      {/* Options */}
      <div className="space-y-4">
        <h4 className="text-white font-medium">Quiz Options</h4>
      ...
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-600 rounded-xl p-8 max-h-96 overflow-y-auto">
        <div className="text-center">
          ...
          <p className="text-gray-300 mb-6 text-lg">
            You answered <span className="text-blue-400 font-semibold">{score.correct}</span> of <span className="text-blue-400 font-semibold">{score.total}</span> questions correctly
          </p>
        ...
        <div className="mt-8 flex justify-center space-x-3">
          <button
            ...
            className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl font-semibold hover:from-blue-600 hover:to-blue-700 transition-all duration-200 shadow-lg shadow-blue-500/30 hover:scale-105"
          >
            <Edit3 className="w-4 h-4" />
            <span>Retry</span>
          </button>
          <button
            onClick={onClose}
            className="flex items-center space-x-2 px-6 py-3 bg-gray-700 text-gray-300 rounded-xl font-semibold hover:bg-gray-600 hover:text-white transition-all duration-200 border border-gray-600"
          >
            <X className="w-4 h-4" />
    ...
    <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-600 rounded-xl p-6 max-h-96 overflow-y-auto">
      ...
      {currentQ && (
        <div className="space-y-6">
          ...
          {currentQ.type === 'true_false' && (
            <div className="grid grid-cols-2 gap-4">
              <label className={`flex items-center justify-center space-x-2 p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 ${
      ...
      <div className="flex justify-between items-center mt-8 pt-4 border-t border-gray-600">
        <button
          ...
          className="flex items-center space-x-2 px-4 py-2 bg-gray-700 text-gray-300 rounded-lg hover:bg-gray-600 hover:text-white transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed border border-gray-600"
        >
          <ChevronLeft className="w-4 h-4" /> {/* Changed ArrowLeft to ChevronLeft and removed rotate for LTR */}
          <span>Previous</span>
        </button>
        ...
        {currentQuestion === quiz.questions.length - 1 ? (
          <button
            ...
            className="flex items-center space-x-2 px-6 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg font-semibold hover:from-green-600 hover:to-emerald-700 transition-all duration-200 shadow-lg shadow-green-500/30 hover:scale-105"
          >
          ...
          <button
            ...
            className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg font-semibold hover:from-blue-600 hover:to-blue-700 transition-all duration-200 shadow-lg shadow-blue-500/30 hover:scale-105"
          >
            <span>Next</span>
